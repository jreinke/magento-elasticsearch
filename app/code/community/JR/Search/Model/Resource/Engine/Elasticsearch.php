 ...
 */
class JR_Search_Model_Resource_Engine_Elasticsearch extends JR_Search_Model_Resource_Engine_Abstract
{
     ...
     *
     * @see JR_Search_Model_Resource_Engine_Elasticsearch_Client
     */
    public function __construct()
    {
        $this->_client = Mage::getResourceSingleton('jr_search/engine_elasticsearch_client');
    }

    /**
     * Cleans caches.
     *
     * @return JR_Search_Model_Resource_Engine_Elasticsearch
     */
     ...
     *
     * @return JR_Search_Helper_Elasticsearch
     */
    protected function _getHelper()
    {
        return Mage::helper('jr_search/elasticsearch');
    }
