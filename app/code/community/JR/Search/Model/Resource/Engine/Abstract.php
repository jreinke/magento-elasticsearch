 ...
 */
abstract class JR_Search_Model_Resource_Engine_Abstract
{
    ...
    {
        return Mage::getResourceSingleton('jr_search/engine_index')
     ...
     * Cleans cache.
     *
     * @return JR_Search_Model_Resource_Engine_Abstract
     */
    ...
    {
        return Mage::getResourceModel('jr_search/catalog_product_collection')->setEngine($this);
    }
     ...
     *
     * @return JR_Search_Helper_Data
     */
    protected function _getHelper()
    {
        return Mage::helper('jr_search');
    }
