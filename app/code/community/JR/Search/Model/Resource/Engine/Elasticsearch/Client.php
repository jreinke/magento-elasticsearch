 ...
 */
class JR_Search_Model_Resource_Engine_Elasticsearch_Client extends Elastica_Client
{
    /**
    ...
    {
        $cacheId = JR_Search_Model_Resource_Engine_Elasticsearch::CACHE_INDEX_PROPERTIES_ID;
