 ...
 */
class JR_Search_Model_Resource_Catalog_Product_Collection extends Mage_Catalog_Model_Resource_Product_Collection
{
    /**
     * @var JR_Search_Model_Resource_Engine_Abstract Search engine.
     */
    protected $_engine;
     ...
     *
     * @param JR_Search_Model_Resource_Engine_Abstract $engine
     * @return JR_Search_Model_Resource_Catalog_Product_Collection
     */
    public function setEngine(JR_Search_Model_Resource_Engine_Abstract $engine)
    {
        $this->_engine = $engine;
