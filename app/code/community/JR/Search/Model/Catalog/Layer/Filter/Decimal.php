 ...
 */
class JR_Search_Model_Catalog_Layer_Filter_Decimal extends Mage_Catalog_Model_Layer_Filter_Decimal
{
     ...
     * @return JR_Search_Model_Catalog_Layer_Filter_Decimal
     */
     ...
     *
     * @param JR_Search_Model_Catalog_Layer_Filter_Decimal $filter
     * @param int $range
     * @param int $index
     * @return JR_Search_Model_Catalog_Layer_Filter_Decimal
     */
    ...
    {
        $fieldName = Mage::helper('jr_search')->getAttributeFieldName($this->getAttributeModel());
    ...
    protected function _renderItemLabel($range, $value)
    {
        ...
        $to = Zend_Locale_Format::toFloat($to, array('locale' => Mage::helper('jr_search')->getLocaleCode()));
